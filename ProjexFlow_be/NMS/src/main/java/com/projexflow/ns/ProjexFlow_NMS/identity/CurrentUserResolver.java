package com.projexflow.ns.ProjexFlow_NMS.identity;
...
public class CurrentUserResolver {
    ...
    public StudentProfile student() {
        ...
        StudentProfile sp = umsClient.getStudentByEmail(email());
    ...
    public Long mentorId() {
        ...
        Long id = umsClient.getMentorByEmail(email()).getId();
    ...
    public Long adminId() {
        ...
        Long id = umsClient.getAdminByEmail(email()).getId();
